...
app.post('/profile/:id', auth.requireAuth, (req, res) => {profile.handleProfileNameUpdate(req, res, db)})
app.post('/profilepicture/:id', auth.requireAuth, (req, res) => {profile.handleProfilePictureUpdate(req, res, db)})
...
app.get('/S3url', auth.requireAuth, (req, res) => {s3url.getS3url(req, res)})
